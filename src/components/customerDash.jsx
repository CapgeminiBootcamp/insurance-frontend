            ...
            <div className="container">
              <div className="row">
                <div className="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-sm-12">
                  <h1>
                    Hello, <strong>{this.state.customer.cutomerName}</strong>
                    <br />
                    Welcome to <strong>Pure Insurance</strong>
                  </h1>
                  <p>
                    We provide you the best insurance policies so you can ensure
                    the safety of your family for all there future{" "}
                  ...
                  <button
                    onClick={() => this.profile(this.state.customer.customerId)}
                    id="profile"
                  >
                    <a href="#features" className="main-button-slider">
                      Profile{" "}
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="row">
                  ...
                  >
                    <button
                      onClick={() => this.edit(this.state.customer.customerId)}
                    >
                      <div className="features-small-item">
                        ...
                        <p>
                          Customize anything your profile so you can get the
                          best
                        </p>
                      </div>
                    </button>
                  ...
                  >
                    <button
                      onClick={() => this.buy(this.state.customer.customerId)}
                    >
                      <div className="features-small-item">
                        <div className="icon">
                          <i>
                        ...
                        <p>
                          Buy Insurance which suits the needs of your family and
                          goals{" "}
                        </p>
                      </div>
                    </button>
                  ...
                  >
                    <button
                      onClick={() =>
                        this.calculate(this.state.customer.customerId)
                      }
                    >
                      <div className="features-small-item">
                        <div className="icon">
                        ...
                        <p>
                          Use our state of the class term insurance calculator
                          to find your ideal insurance
                        </p>
                      </div>
                    </button>
                  </div>
              ...
              <div className="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                <div className="left-heading">
                  <h2 className="section-title">
                    Let’s discuss about your health benefits.
                  </h2>
                </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-bottom-fix">
                <div className="left-heading">
                  <h2 className="section-title">
                    We can help you to secure you and your loved ones.
                  </h2>
                </div>
                <div className="left-text">
                  <p>
              ...
              <div className="offset-lg-3 col-lg-6">
                <div className="center-text">
                  <p>
                    ...
                    fringilla nulla, at accumsan elit eros a turpis. Ut sagittis
                    lectus libero.placerat nibh. Cras maximus venenatis molestie.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="team-item">
                  <div className="team-content">
                    ...
                    <p>
                      ...
                      placerat nibh. Cras maximus venenatis molestie.
                    </p>
