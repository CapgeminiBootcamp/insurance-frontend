                            ...
                            this.state.insurances.map(
                                insurance =>
                                    <tr key={insurance.insuranceId}>
                                        ...
                                        <td>
                                            <button onClick={() => this.buyInsurance(this.state.customer.customerId, insurance.insuranceId)} className="btn btn-outline-success" style={{ marginLeft: "8px" }} >Buy Now</button>
